--1:
/*
Write a SQL command to show the name, continent and population of all countries.
*/
...
--7:
/*
Two ways to be big: A country is big if it has an area of more than
...
--11:
/*
Show the name and capital where the name and the
capital have the same number of characters.
*/
